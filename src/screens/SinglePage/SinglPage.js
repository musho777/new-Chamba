        ...
        {data &&
          (() => {
            ...
            try {
              ...
              parsedDescription = data?.background ? '' : [];
            }

            // Extract descriptions array if it's in the new format
            if (
              parsedDescription &&
              typeof parsedDescription === 'object' &&
              parsedDescription.descriptions
            ) {
              parsedDescription = parsedDescription.descriptions;
            }
            ...
            return (
              <Posts
                ...
                liked={
                  data?.like_auth_user.findIndex(
                    (elm, i) => elm.user_id == user.data.id,
                  ) >= 0
                }
