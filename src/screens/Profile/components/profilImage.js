      ...
      return (
        <TouchableOpacity
          ...
          style={[
            ...
            index == mainImageData?.length - 1 && {marginBottom: 10},
          ]}>
          <View style={{justifyContent: 'center', alignItems: 'center'}}>
            <Text
              style={[Styles.darkSemiBold14, {marginTop: 5, marginBottom: 2}]}>
              {item?.name}
            </Text>
            <Image
              style={styles.bgImage1}
              source={{
                uri: `https://chambaonline.pro/uploads/${item?.photo_array[0]?.photo}`,
              }}
            />
          </View>
        </TouchableOpacity>
    ...
    <View style={{justifyContent: 'center', alignItems: 'center'}}>
      ...
      <BootomModal ref={bottomSheetRef2} snapPoints={snapPoints}>
        <View style={{gap: 20, paddingHorizontal: 10}}>
          ...
          <TouchableOpacity
            accessibilityLabel="Photo4"
            style={styles.iconWrapper}>
            <Image
              style={styles.icon}
              source={require('../../../assets/img/edit.png')}
            />
            <Text style={styles.text} onPress={() => changeImg()}>
              {t(mainData.lang).ChangePhoto}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            accessibilityLabel="Photo5"
            style={styles.iconWrapper}
            onPress={() => DelatePhoto()}>
            <Image
              style={styles.icon}
