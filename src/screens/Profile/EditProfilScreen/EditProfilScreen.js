        ...
        <SafeAreaView style={{flex: 1}}>
          <KeyboardAvoidingView
            ...
            <ScrollView
              ...
              <Text
                style={[
                  Styles.balihaiMedium10,
                  {paddingHorizontal: 17, marginTop: 10, color: '#000'},
                ]}>
                  ...
                  {fontFamily.map((elm, i) => {
                    return (
                      <Text
                        ...
                        key={i}
                        style={{fontSize: 10, fontFamily: elm, color: '#000'}}>
                        {elm}
                      </Text>
                    );
                  })}
              ...
              <Fild
                ...
                multiline={true}
                value={discription}
                hadnelChange={e => setDiscription(e)}
                placeholder={
                  accauntType ? t(mainData.lang).Brieflyaboutyourself : 'О нас'
                }
              />
              <View
                style={{
              ...
              <Text
                style={[
                  Styles.balihaiMedium10,
                  {paddingHorizontal: 17, marginTop: 5, color: 'red'},
                ]}>
                Чем больше заполнишь информацию о себе, тем точнее будет
                предлагаться контент, контент от твоих коллег/конкурентов по
                сфере/отрасли, а также контент из твоего города.
              </Text>
              <View>
                {accauntType && (
                  <DateComponent
                ...
                {accauntType && (
                  <ChnageGender value={gender} setValue={e => setGender(e)} />
                )}
                {!accauntType && (
                  <Fild
                    value={email}
                    hadnelChange={e => setEmail(e)}
                    svg={<EmailSvg />}
                    placeholder={t(mainData.lang).Mail}
                  />
                )}
                <Fild
                  value={phonNumber}
                  hadnelChange={e => setPhonNumber(e)}
                  svg={<PhoneSvg />}
                  placeholder={t(mainData.lang).Phonenumber}
                />
                <Location
                  country_id={country_id}
                  setCountry_id={e => setCountry_id(e)}
                  setLocation={e => setLocation(e)}
                  loaction={loaction}
                />
                <Position_profession
                  setLocation={e => setOtrasl(e)}
                  loaction={otrasl}
                />
                {accauntType && (
                  <Fild
                    bB={0}
                    value={workLocation}
                    hadnelChange={e => setWorkLocation(e)}
                    svg={<WorkLocation />}
                    placeholder={t(mainData.lang).Placeofwork}
                  />
                )}
                ...
                <Fild
                  multiline={true}
                  value={ooo}
                  hadnelChange={e => setOoo(e)}
                  svg={<WorkLocationSvg />}
                  placeholder={
                    !accauntType ? 'Адрес компании' : 'Адрес предприятия'
                  }
                />

                <Profiesions
                  setLocation={e => setProfation(e)}
                  loaction={profation}
                />
                {!accauntType && (
                  <Fild
                    value={graf}
                    hadnelChange={e => setGraf(e)}
                    svg={<WatchSvg />}
                ...
                {!accauntType && (
                  <Fild
                    value={web}
                    hadnelChange={e => setWeb(e)}
                    svg={<NetWorkSvg />}
                    placeholder={t(mainData.lang).Website}
                  />
                )}
        ...
        <SafeAreaView style={{flex: 1}}>
          <KeyboardAvoidingView
            ...
            <ScrollView
                  ...
                  {fontFamily.map((elm, i) => {
                    return (
                      <Text
                        ...
                        key={i}
                        style={{fontSize: 10, fontFamily: elm}}>
                        {elm}
                      </Text>
                    );
                  })}
              ...
              <Text
                style={[
                  Styles.balihaiMedium8,
                  {paddingHorizontal: 17, marginTop: 5},
                ]}>
                (Чем больше заполните информацию о компании, тем более точный
                контент будет предлагаться) Помимо выбранных Вами рубрик, будет
                предлагаться контент от ваших конкурентов с вашего города)
              </Text>
              <View>
                <Location
                  country_id={country_id}
