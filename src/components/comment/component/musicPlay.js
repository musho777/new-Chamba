...
export const MusicPlay = forwardRef(({categoryID, onSend}, ref) => {
  ...
  const Eda = [
    ...
    [
      30, 29, 30, 39, 17, 50, 26, 21, 12, 44, 50, 43, 48, 38, 22, 42, 28, 18,
      42, 37, 45, 18, 33, 14,
    ],
    [
      35, 15, 28, 44, 19, 21, 50, 31, 12, 40, 14, 48, 38, 25, 17, 23, 47, 29,
      36, 45, 32, 26, 11, 30, 24, 41, 18, 27, 13, 22, 46, 16,
    ],
    [
      17, 42, 23, 35, 11, 30, 49, 14, 27, 45, 32, 19, 21, 46, 38, 13, 25, 40,
      31, 12, 48, 26, 20, 15,
    ],
  ...
  const Anticvar = [
    ...
    [
      19, 2, 14, 16, 10, 7, 27, 5, 22, 9, 21, 7, 20, 12, 22, 18, 1, 2, 21, 7, 8,
      25, 5, 21, 12, 11, 10, 2, 5, 4, 14, 1, 12, 14, 5, 18, 8, 26, 6, 22, 6, 22,
      16, 6, 7, 9, 18, 5, 7, 8, 7, 9, 2, 6, 12, 16, 23, 21,
    ],
    [5, 9, 10, 12, 20, 3, 13],
  ];
  ...
  const transport = [
    [
      48, 31, 23, 36, 35, 42, 38, 11, 44, 39, 28, 39, 10, 32, 41, 40, 39, 26,
      27, 41, 46, 29, 42, 21, 34, 39, 31, 41, 34, 12, 42, 34, 41, 38, 44, 32,
      41, 41,
    ],
    [26, 36, 34, 45, 50, 14, 43, 37, 39, 29],
    [47, 16, 10, 17, 18, 14, 12, 28, 19, 25, 45, 10, 20, 22],
    [18, 17],
    [10, 10],
    [
      33, 18, 18, 49, 41, 14, 28, 30, 16, 28, 24, 21, 15, 39, 24, 23, 32, 12,
      28, 24, 24, 17, 32, 40, 25, 44, 40, 18,
    ],
    [47, 16, 19, 16],
    [13, 39, 39, 49, 32, 16],
    [13, 16, 47, 15, 22, 15, 49, 20],
    [
      18, 45, 47, 44, 50, 39, 23, 32, 15, 31, 26, 20, 13, 21, 26, 47, 16, 25,
      42, 33,
    ],
    [50, 46],
    [
      33, 35, 35, 50, 23, 39, 31, 48, 14, 36, 37, 17, 31, 36, 46, 50, 17, 10,
      17, 16, 15, 49, 13, 39, 42, 17, 48, 26,
    ],
    [
      20, 39, 24, 36, 13, 45, 29, 38, 30, 21, 34, 30, 29, 16, 49, 41, 25, 19,
      10, 14, 30, 15,
    ],
    [12, 48, 17, 49, 13, 34, 12, 23, 35, 45, 50, 30, 43, 22, 11, 38],
    [
      10, 13, 41, 48, 34, 36, 43, 35, 15, 35, 12, 48, 38, 35, 22, 20, 42, 38,
      29, 47, 15, 30, 30, 30, 20, 18, 50, 11, 29, 42, 43, 21, 15, 29, 14, 31,
      50, 19,
    ],
    [
      34, 13, 24, 29, 49, 15, 13, 23, 34, 32, 38, 47, 40, 38, 17, 32, 17, 37,
      38, 34, 23, 43, 30, 46,
    ],
  ];
  ...
  useEffect(() => {
    ...
    const uniqueCategoryIds = [
      ...new Set(getSound.data.map(item => item.category_id)),
    ];
    let emojys = [];
    uniqueCategoryIds.map((elm, i) => {
      if (elm == 138) {
        ...
        let emojy1 = [
          '🛠',
          '🛠',
          require('../../../assets/img/drill2-min.png'),
          require('../../../assets/img/vacuu.png'),
        ];
        emojy1.map((elm, i) => {
          emojys.push(elm);
        });
        ...
        let emojy1 = [
          ...
          require('../../../assets/img/drill-min.png'),
          '🔨',
          require('../../../assets/img/drill-satire-min.png'),
          '🪚',
          require('../../../assets/img/bosch-drill-min.png'),
          require('../../../assets/img/welding-helmet--min.png'),
          '🔧',
          require('../../../assets/img/drilln.png'),
        ];
        emojy1.map((elm, i) => {
          emojys.push(elm);
        });
        ...
        let emojy1 = [
          '🏎️',
          '🏍️',
          require('../../../assets/img/red-sport-car-min.png'),
          '🚗',
          '🚖',
          '🛻',
          '🚚',
          require('../../../assets/img/sport-car-min.png'),
          require('../../../assets/img/sport-car.png'),
          require('../../../assets/img/sport-car2.png'),
          '🚍',
          '🚘',
          '🚜',
          '🚜',
  ...
  const handleButtonClick = index => {
    ...
    if (isPlaying != index) {
      ...
      const sound = new Sound(
        `https://chambaonline.pro/uploads/audio/${getSound.data[index].name}`,
        null,
        error => {
          if (error) {
            return;
  ...
  return (
    <BootomModal ref={ref} snapPoints={snapPoints} close={() => Stop()}>
      <FlatList
        data={getSound.data}
        ...
        ListHeaderComponent={
          <View
            ...
            <Text style={[Styles.darkMedium14, {textAlign: 'center'}]}>
              Данная публикация выложена в несколько рубрик, звуковые
              комментарии предложены согласно рубрикам.
            </Text>
            <View>
              {categoryID?.map((elm, i) => {
                return (
                  <Text style={[Styles.darkMedium14, {textAlign: 'center'}]}>
                    - {elm?.name}
                  </Text>
        ...
        ListEmptyComponent={
          <View
            ...
            <Text style={Styles.darkMedium14}>
              {t(mainData.lang).Nosoundsavailable}
            </Text>
          </View>
        }
          ...
          return (
            <TouchableOpacity activeOpacity={1} style={styles.wrapper}>
              <View
                ...
                <View>
                  {!isEmoji(emojy[index]) ? (
                    <Text style={{fontSize: 25}}>{emojy[index]}</Text>
                  ) : (
                    <View>
                      {emojy[index] && (
                        <Image
