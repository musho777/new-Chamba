...
export const Posts = ({
  ...
  const renderItem = ({item, index}) => {
    ...
    return (
      <TouchableOpacity onPress={e => handleClick(e, item)} activeOpacity={1}>
        <Image
              ...
              <View style={[{paddingHorizontal: 10}]}>
                <View>
                    ...
                    <Text
                      style={[
                        Styles.darkMedium13,
                        {
                          ...
                          fontFamily: GetFont(font_family, active),
                          backgroundColor: GetBegraund(podcherknuti, active),
                          marginTop: 3,
                          paddingHorizontal: 5,
                        },
                      ]}>
                  ...
                  <View style={{marginBottom: 3, paddingHorizontal: 5}}>
                    {description[active].length > MAX_Height && (
                      <TouchableOpacity onPress={() => startAnimation(true)}>
                        <Text
                          style={[Styles.balihaiMedium13, {color: 'white'}]}>
                          Показать больше
                        </Text>
                      </TouchableOpacity>
                    )}
          ...
          <ScrollView
            ...
            {description?.length > 0 && description && (
              <TouchableOpacity style={{padding: 10}} activeOpacity={1}>
                ...
                {description?.length > 0 && description[active] && (
                  <TouchableOpacity onPress={() => startAnimation(false)}>
                    <Text style={[Styles.balihaiMedium13]}>Cвернуть</Text>
                  </TouchableOpacity>
                )}
              </TouchableOpacity>
            )}
                            ...
                            <View style={[{paddingHorizontal: 10}]}>
                              <View>
                                  ...
                                  <Text
                                    style={[
                                      Styles.darkMedium13,
                                      {
                                        ...
                                        fontFamily: GetFont(font_family, 2),
                                        backgroundColor: GetBegraund(
                                          podcherknuti,
                                          2,
                                        ),
                                    ...
                                    {`${description.descriptions[2].slice(
                                      0,
                                      MAX_Height,
                                    )}`}
                                  </Text>
                                ...
                                <View
                                  ...
                                  {description.descriptions[2].length >
                                    MAX_Height && (
                                    <TouchableOpacity
                                      onPress={() => {
                                        setActive(2);
                        ...
                        }}>
                        {
                          <View style={[{paddingHorizontal: 10}]}>
                            <View>
                                ...
                                <Text
                                  style={[
                                    Styles.darkMedium13,
                                    {
                                      ...
                                      fontFamily: GetFont(font_family, 3),
                                      backgroundColor: GetBegraund(
                                        podcherknuti,
                                        3,
                                      ),
                                  ...
                                  {`${description.descriptions[3].slice(
                                    0,
                                    MAX_Height,
                                  )}`}
                                </Text>
                              ...
                              <View
                                style={{marginBottom: 3, paddingHorizontal: 5}}>
                                {description.descriptions[3].length >
                                  MAX_Height && (
                                  <TouchableOpacity
                                    onPress={() => {
                                      setActive(3);
            ...
            <View style={styles.bodyWrapper}>
              <TouchableOpacity
                ...
                onLongPress={e => {
                  e.preventDefault();
                  dispatch(
                    GetPostLikeAction({post_id: id}, staticdata.token, 1),
                  );
                  setShowLike(true);
                }}
                onPress={e => {
                ...
                <Text style={[Styles.darkMedium14, {color: 'white'}]}>
                  {like.like_count}
                </Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                onPress={() => {
                  dispatch(
                    GetFollowerAction(
                      {search: '', user_id: user.allData.data.id},
                      staticdata.token,
                      1,
                    ),
                  );
              ...
              <View
                ...
                {showStatisitc == 1 && my && view_count > 0 && (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.hover,
                      {position: 'absolute', right: 50, height: 36},
                    ]}>
                    <Text style={[Styles.whiteRegular12]}>
                ...
                <TouchableOpacity
                  ...
                  <View style={styles.hoverItem}>
                    ...
                    <Text style={[Styles.balihaiRegular14, {color: 'white'}]}>
                      {view_count}
                    </Text>
                  </View>
                </TouchableOpacity>
          ...
          {photos.map((elm, i) => {
            ...
            return (
              <View
                ...
                style={[
                  styles.gridRow,
                  {marginBottom: i < photos.length - 1 ? 5 : 0},
                ]}>
                <TouchableOpacity
                  style={styles.gridPhotoContainer}
                  onPress={() => {
                      ...
                      }}>
                      {
                        <View style={[{paddingHorizontal: 10}]}>
                          <View>
                              ...
                              <Text
                                style={[
                                  Styles.darkMedium13,
                                  {
                                    ...
                                    fontFamily: GetFont(font_family, i),
                                    backgroundColor: GetBegraund(
                                      podcherknuti,
                                      i,
                                    ),
                                ...
                                {`${description.descriptions[i].slice(
                                  0,
                                  MAX_Height,
                                )}`}
                              </Text>
                            ...
                            <View
                              style={{marginBottom: 3, paddingHorizontal: 5}}>
                              {description.descriptions[i].length >
                                MAX_Height && (
                                <TouchableOpacity
                                  onPress={() => {
                                    setActive(i);
                  ...
                  <FastImage
                    source={{
                      uri: `https://chambaonline.pro/uploads/${photos[i].photo}`,
                    }}
                    style={[
                      styles.gridPhoto,
                      {height: photos.length == 1 ? 350 : 190},
                      getBorderStyle(),
                    ]}
                  />
                </TouchableOpacity>
