...
import {Success} from '../assets/svg/Svgs';
  ...
  const uploadFile = async () => {
    ...
    try {
      const response = await fetch(
        'https://chambaonline.pro/api/new_function_idea',
        {
          method: 'POST',
          headers: {
        ...
        {!succass ? (
          <View
            ...
            <Text
              ...
              Выберите файл и оставьте комментарий
            </Text>
            ...
            {loading ? (
              ...
              <Button title="Отправить" onPress={uploadFile} />
            )}
