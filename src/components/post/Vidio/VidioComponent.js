  ...
  (
    ...
    useEffect(() => {
      if (viewableItems?.length) {
        if (
          currentId === viewableItems[0]?.item.id &&
    ...
    return (
      <View
        style={{
          height: !fullScreen ? height : windowHeight,
        ...
        <TouchableOpacity
          ...
          <Video
            ...
            source={{
              uri: `https://chambaonline.pro/uploads/${item.video}`,
              cache: true,
            }}
            resizeMode={'cover'}
        ...
        {fullScreen && (
          <View style={styles.slider}>
            <Text style={[Styles.whiteSemiBold13, {textAlign: 'center'}]}>
